$(function () {
    $('#temperature').highcharts({
        ...
        title: {
            text: 'Temp\351rature de la ruche'
        },
        subtitle: {
            text: document.ontouchstart === undefined ?
                'Cliquez et faites glisser dans la zone de tra\347age pour zoomer' :
                'Pincez le graphique pour agrandir'
        },
        xAxis: {
            type: 'datetime',
            minRange: 24 * 3600000 // 1 journee
        },
        yAxis: {
            title: {
                text: 'Temp\351rature'
